...
// CP437 VGA 8x16 font data
const FONT_DATA: [[u8; 16]; 256] = [
    ...
    [0x00, 0x00, 0xcc, 0x00, 0x00, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00, 0x00], // [ü] (129)
    ...
    [0x00, 0x00, 0xcc, 0x00, 0x00, 0x78, 0x0c, 0x7c, 0xcc, 0xcc, 0xcc, 0x76, 0x00, 0x00, 0x00, 0x00], // [ä] (132)
    ...
    [0x00, 0x00, 0xc6, 0x00, 0x00, 0x7c, 0xc6, 0xfe, 0xc0, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00, 0x00], // [ë] (137)
    [0x00, 0x60, 0x30, 0x18, 0x00, 0x7c, 0xc6, 0xfe, 0xc0, 0xc0, 0xc6, 0x7c, 0x00, 0x00, 0x00, 0x00], // [è] (138)
    [0x00, 0x00, 0x66, 0x00, 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3c, 0x00, 0x00, 0x00, 0x00], // [ï] (139)
    ...
    [0x00, 0xc6, 0x00, 0x10, 0x38, 0x6c, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00, 0x00], // [Ä] (142)
    ...
    [0x00, 0x00, 0xc6, 0x00, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00, 0x00], // [ö] (148)
    ...
    [0x00, 0x00, 0xc6, 0x00, 0x00, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7e, 0x06, 0x0c, 0x78, 0x00], // [ÿ] (152)
    [0x00, 0xc6, 0x00, 0x7c, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00, 0x00], // [Ö] (153)
    [0x00, 0xc6, 0x00, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0x7c, 0x00, 0x00, 0x00, 0x00], // [Ü] (154)
    ...
    [0x00, 0x00, 0x78, 0xcc, 0xcc, 0xcc, 0xd8, 0xcc, 0xc6, 0xc6, 0xc6, 0xcc, 0x00, 0x00, 0x00, 0x00], // [ß] (225)
    ...
    [0x00, 0x00, 0x00, 0xfe, 0xc6, 0x60, 0x30, 0x18, 0x30, 0x60, 0xc6, 0xfe, 0x00, 0x00, 0x00, 0x00], // [Σ] (228)
...
impl BitmapFont {
    pub fn generate_atlas() -> Vec<u8> {
        ...
        for (i, glyph) in FONT_DATA.iter().enumerate() {
            ...
            let start_x = col * GLYPH_W;
            let start_y = row * GLYPH_H;

            for (y_offset, byte) in glyph.iter().enumerate() {
                let y = start_y + y_offset as u32;
                for x_offset in 0..8 {
                    let bit = (byte >> (7 - x_offset)) & 1;
                    let x = start_x + x_offset as u32;

                    let index = ((y * ATLAS_W + x) * 4) as usize;
                    if bit == 1 {
                        data[index] = 255;     // R
                        data[index + 1] = 255; // G
                        data[index + 2] = 255; // B
    ...
    pub fn glyph_uv(ch: u8) -> (f32, f32, f32, f32) {
        ...
        // Inset by half a pixel to avoid bleeding
